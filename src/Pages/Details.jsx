  ...
  return (
    <div className='detailsmain'>
      ...
      <div className='purpleone'>
          ...
          <p style={{textAlign  :"center", color : "grey"}}><span style={{fontWeight : "bolder"}}>Added Date :</span>{item.date}</p>
          <p style={{color : "grey", fontSize : "14px", textAlign  : "center"}}>{item.content}</p>
          <p style={{color : "grey", fontSize : "14px", textAlign  : "center"}}>{item.city} / {item.state}</p>
      </div>
